...
```
> 三根重叠K线是否要求连续？它们不存在中枢的方向问题，哪些是Z走势段呢？ 
>
> 当然是连续三根，一样有方向，例如从高位下来形成的，方向就是下上下，其实，一般不用看1分钟图当最低的，看分时图更清楚
